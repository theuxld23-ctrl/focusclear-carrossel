...
pytest tests/                                    # roda todos os testes (42 funções, 12 suítes)
...
tests/             # 1 teste por etapa/feature (12 suítes; rodam via pytest ou como módulo)
```
